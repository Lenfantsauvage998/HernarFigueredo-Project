...
const NotFound: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#2c2b2b] flex flex-col items-center justify-center px-4 pt-20">
      <p className="text-[#f26822] text-8xl font-bold mb-4">404</p>
      ...
      <Link
        to="/"
        className="bg-[#f26822] hover:bg-[#d45c1a] text-white font-semibold px-6 py-3 rounded-xl transition-colors text-sm"
      >
        Volver al inicio
      </Link>
    </div>
